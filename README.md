...
총 **42문제**입니다. 화면에서는 **기본 개념 문제**와 **응용 문제**를 고르고, 각 묶음에서 SELECT·WHERE·ORDER BY·JOIN 분류를 접고 펼칠 수 있어요. 기본 개념 문제는 문법 하나에 집중하고, 응용 문제는 현재 배운 범위에서 실무 상황을 조합합니다. 문자열 연결은 선택 문제입니다. 브랜치를 바꿀 필요는 없습니다.
